...
- O que vendemos: <descrição> [material | inferência | confirmado]
- Para quem resolve o quê: <descrição> [material | inferência | confirmado]
- Diferenciais que podemos citar: <descrição> [material | inferência | confirmado]
- O que NÃO podemos prometer: <descrição> [material | inferência | confirmado]
...
- Bom fit quando: <critérios>
- Descartar quando: <critérios>
...
- Idioma: <idioma>
- Tom: <descrição>
- Tamanho máximo do primeiro e-mail: <limite>
- Exemplos aprovados: <referências ou exemplos>
...
- Envio de teste feito: <data, aprovado por | não feito>

## Nunca contatar

- <empresa ou domínio> — <cliente | parceiro | negociação aberta | pediu para parar | outro motivo>
